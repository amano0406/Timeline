...
public sealed partial class TimelineLocalApiClient
{
    ...
    public async Task<WindowsCodexOverview> GetWindowsCodexOverviewAsync(CancellationToken cancellationToken = default)
    {
        ...
        {
            LogOptionalLocalApiReadFailure(ex, "Failed to load TimelineForWindowsCodex overview.");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            LogOptionalLocalApiReadFailure(ex, "Failed to load TimelineForWindowsCodex thread {ItemId}.", itemId);
    ...
    public async Task<ChatGptOverview> GetChatGptOverviewAsync(CancellationToken cancellationToken = default)
    {
        ...
        {
            LogOptionalLocalApiReadFailure(ex, "Failed to load TimelineForChatGPT overview.");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            LogOptionalLocalApiReadFailure(ex, "Failed to load TimelineForChatGPT thread {ItemId}.", itemId);
