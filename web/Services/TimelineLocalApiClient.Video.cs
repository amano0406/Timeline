...
public sealed partial class TimelineLocalApiClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            LogOptionalLocalApiReadFailure(ex, "Failed to load TimelineForVideo overview.");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            LogOptionalLocalApiReadFailure(ex, "Failed to load TimelineForVideo file detail.");
