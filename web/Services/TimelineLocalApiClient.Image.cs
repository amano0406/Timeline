...
public sealed partial class TimelineLocalApiClient
{
    public async Task<AudioModelInventoryResult> GetImageModelsAsync(CancellationToken cancellationToken = default)
    {
        ...
        {
            LogOptionalLocalApiReadFailure(ex, "Failed to load TimelineForImage model inventory.");
    ...
    public async Task<ImageOverview> GetImageOverviewAsync(CancellationToken cancellationToken = default)
    {
        ...
        {
            LogOptionalLocalApiReadFailure(ex, "Failed to load TimelineForImage overview.");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            LogOptionalLocalApiReadFailure(ex, "Failed to load TimelineForImage file detail.");
