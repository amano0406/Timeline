...
公開 GitHub Release の ZIP をダウンロードして展開する方式なら、通常 Git も GitHub アカウントも不要です。
...
| 用途 | Git 必須か | 備考 |
|---|---:|---|
| サブ製品を Git clone でインストールする | 必須 | Release ZIP 方式にすれば不要 |
...
つまり、一般ユーザー向けに Git を必須にしないためには、インストール方式を Release ZIP に寄せます。
